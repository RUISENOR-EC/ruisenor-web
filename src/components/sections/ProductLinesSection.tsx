...
import pastaCacao from '../../assets/brand/chocolate-tablet.png'
      ...
      <div className="mx-auto max-w-[1440px]">
        <Reveal>
          ...
          <div className="mt-5 flex flex-col justify-between gap-5 border-b border-cacao/20 pb-8 md:flex-row md:items-end">
            ...
            <p className="max-w-xs text-sm leading-6 text-ink/70">Explora cada línea y encuentra el producto que quieres disfrutar o regalar.</p>
          </div>
        </Reveal>
        ...
        <div className="mt-10 grid gap-5 md:grid-cols-2">
          <Reveal className="group relative min-h-[380px] overflow-hidden bg-cacao text-marfil">
            <motion.div ref={chocolateTilt.ref} style={chocolateTilt.style} className="tilt relative min-h-[380px] w-full">
              <img src={pastaCacao} alt="Pasta de cacao Ruiseñor" width={768} height={1376} loading="lazy" className="absolute inset-0 h-full w-full scale-110 object-cover transition duration-700 group-hover:scale-[1.18]" />
