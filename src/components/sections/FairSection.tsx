      ...
      <div className="mx-auto grid max-w-[1440px] items-center gap-12 lg:grid-cols-[1.2fr_0.8fr]">
        <Reveal>
          ...
          <h2 className="mt-6 max-w-3xl font-serif-brand text-5xl font-semibold leading-[0.9] sm:text-7xl">
            Ruiseñor también se encuentra fuera de la pantalla.
          </h2>
          <p className="mt-7 max-w-xl text-lg leading-8 text-espresso/70">
            <span className="font-semibold text-espresso">{content.name}</span> tendrá una sección propia con la información del stand y una promoción que el negocio podrá actualizar desde Supabase.
          </p>
          ...
          <div className="mt-8 grid max-w-xl gap-4 border-t border-espresso/20 pt-5 sm:grid-cols-2">
            <div className="flex gap-3">
              ...
              <div>
                <p className="text-[0.62rem] font-bold uppercase tracking-[0.16em] text-espresso/55">Fecha</p>
            ...
            <div className="flex gap-3">
              ...
              <div>
                <p className="text-[0.62rem] font-bold uppercase tracking-[0.16em] text-espresso/55">Lugar</p>
            ...
            <div className="flex gap-3">
              ...
              <div>
                <p className="text-[0.62rem] font-bold uppercase tracking-[0.16em] text-espresso/55">Stand</p>
                <p className="mt-1 text-sm font-semibold">{content.stand}</p>
              </div>
            </div>
          </div>

          <div className="mt-7 max-w-xl border-l-2 border-espresso/40 pl-4 text-sm leading-6 text-espresso/70">
            <p className="text-[0.62rem] font-bold uppercase tracking-[0.16em] text-espresso/55">Promoción en el QR</p>
        ...
        <Reveal className="mx-auto w-full max-w-xs rotate-1">
          ...
          >
            <div className="flex items-start justify-between border-b border-dashed border-espresso/25 pb-4">
              <div>
                <p className="text-[0.58rem] font-bold uppercase tracking-[0.2em] text-espresso/55">Pase de feria</p>
            ...
            <p className="border-t border-dashed border-espresso/25 pt-4 text-[0.6rem] font-bold uppercase tracking-[0.16em] text-espresso/55">
