    ...
    <section id="contacto" className="bg-espresso px-5 py-20 text-marfil lg:px-10 lg:py-24">
      <div className="mx-auto grid max-w-[1440px] gap-10 lg:grid-cols-[1.2fr_0.8fr] lg:items-end">
        <Reveal>
          ...
          <p className="mt-7 max-w-xl text-lg leading-8 text-marfil/60">Escríbenos para conocer formatos, disponibilidad y realizar tu pedido.</p>
        ...
        <Reveal className="lg:border-l lg:border-dorado lg:pl-10">
          ...
          <div className="mt-6 flex items-center gap-3 text-sm text-marfil/55"><FaWhatsapp size={17} aria-hidden="true" /> Respuesta directa del negocio</div>
        </Reveal>
      </div>
    </section>
  )
