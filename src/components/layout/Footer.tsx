...
export function Footer() {
  return (
    <footer className="border-t border-marfil/10 bg-espresso px-5 py-10 text-marfil lg:px-10">
      ...
      <div className="mx-auto mt-10 max-w-[1440px] border-t border-marfil/10 pt-5 text-[0.62rem] font-semibold uppercase tracking-[0.16em] text-marfil/35">© 2026 Ruiseñor · Datos de contacto pendientes de confirmación</div>
    </footer>
  )
}
